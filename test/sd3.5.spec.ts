...
describe("Stable Diffusion 3.5", () => {
  ...
  describe("Return content in webhook", () => {
    it("text2image works with 1 image", async () => {
      ...
      /**
       * TODO: There is some kind of race condition here I can't figure out. It does seem to effect
       * other webhook tests, but it does seem to effect this one. comfyui-api logs report that it got no response
